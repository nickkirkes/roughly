...
Minimal fixture project for Roughly's CI dogfood fix scenario (E06.S2). Not a Roughly install — this is the *target* that `/roughly:fix --ci` operates on. Ships with one intentional bug.
