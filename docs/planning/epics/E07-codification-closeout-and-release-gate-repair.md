...
|---|---|---|---|---|
| E07.S3 — CHANGELOG backfill + heading revert | [#93](https://github.com/nickkirkes/roughly/issues/93) | `8223c50` | 1 | Before every other story (rewrites the heading their entries land under) |
| E07.S1 — Dogfood harness diagnostics | [#94](https://github.com/nickkirkes/roughly/issues/94) | `8223c50` | 2 | After S3 |
| E07.S2 **Phase 1** — discovery dispatch | [#95](https://github.com/nickkirkes/roughly/issues/95) | `8223c50` | 3 | Opens once S1 merges; **runs concurrently with wave 4** |
| E07.S5 — Stage 4 contract | [#96](https://github.com/nickkirkes/roughly/issues/96) | `8223c50` | 4 | After S3; before S6 (line budget, R3) |
| E07.S6 — Granularity guard + ADR-021 | [#97](https://github.com/nickkirkes/roughly/issues/97) | `8223c50` | 4 | After S5 |
| E07.S4 — Intra-epic AC codifier | [#98](https://github.com/nickkirkes/roughly/issues/98) | `8223c50` | 4 | Unordered within the wave; **optional** — first cut if the dispatch budget compresses |
| E07.S2 **Phase 2** — 3 proving runs | [#95](https://github.com/nickkirkes/roughly/issues/95) | `8223c50` | 5 | After S1, S5, S6 have merged (AC1's predecessor set). S4 not required |
| E07.S7 — Tag-prep wrap | [#99](https://github.com/nickkirkes/roughly/issues/99) | `8223c50` | 6 | Last; after S2's disposition is recorded |

Deferred: [#100](https://github.com/nickkirkes/roughly/issues/100) (B3, v0.1.10) · [#101](https://github.com/nickkirkes/roughly/issues/101) (DI-001, v0.2.0-adjacent) · [#102](https://github.com/nickkirkes/roughly/issues/102) (ADR-009/010 cleanup, v0.2.0) — all three briefs derived from `8223c50`, same as the story rows above.
